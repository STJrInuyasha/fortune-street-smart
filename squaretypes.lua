	...
	SquareTypes[6]	= {	name	= "Diamond",	image	= love.graphics.newImage("images/GroundSuit03.png")	}
	SquareTypes[7]	= {	name	= "Club",		image	= love.graphics.newImage("images/GroundSuit04.png")	}
	SquareTypes[8]	= {	name	= "Suit Chg.",	image	= love.graphics.newImage("images/GroundCSuit01.png")	}
	SquareTypes[9]	= {	name	= "Venture",	image	= love.graphics.newImage("images/GroundVenture.png")	}
	SquareTypes[10]	= {	name	= "Arcade",		image	= love.graphics.newImage("images/GroundArcade.png")	}
	SquareTypes[11]	= {	name	= "Roll On",	image	= love.graphics.newImage("images/GroundRollOn.png")	}
	SquareTypes[12]	= {	name	= "Stocks",		image	= love.graphics.newImage("images/GroundStockBroker.png")	}
